...
@Component({
    selector: 'printreport-component',
...
export class PrintreportComponent implements OnInit {
    ...
    ngOnInit() {
        if (localStorage.getItem('offlinereport') != null) {
                ...
                this.nowdate = new Date().getDate() + "/" + (new Date().getMonth() + 1) + "/" + new Date().getFullYear();
    ...
    csvt() {
        ...
        var options = {
            ...
            title: "Order Report",
            useBom: true,
            headers: Object.keys(this.dayreport[0])
        };
        var name = "Order Report" + new Date().getDate() + "_" + (new Date().getMonth() + 1) + "_" + new Date().getFullYear()+"_"+new Date().getHours() + "_" + new Date().getMinutes();
